...
/**
 * Loopline core module. It provides static properties and
 ...
 * // mixin loopline module
 * app = loopline(express());
 * ```
 *
 * @property {String} version Version of Loopline framework.  Static read-only property.
 ...
 * @property {String} faviconFile Path to a default favicon shipped with Loopline.
 * Use as follows: `app.use(require('serve-favicon')(loopline.faviconFile));`
 * @class loopline
 * @header loopline
 */

var loopline = module.exports = createApplication;
...
function createApplication(app, options) {
  app = app || {};
 ...
 * The method can be used by Loopline
 ...
 * @property {Object} connector Loopline connector.
